            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">
                        Menciptakan liburan sempurna anda
                    </h2>
                    <p class="mt-4 text-lg text-gray-500">
                        Keunggulan kami dalam memberikan pengalaman liburan tak terlupakan di Bali.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 hover:shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-shadow duration-300 text-center flex flex-col items-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Pemandu Lokal Ahli</h3>
                        <p class="text-gray-500 text-sm leading-relaxed">
                            Pemandu lokal profesional siap menemani dan menceritakan keunikan setiap sudut magis Bali.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 hover:shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-shadow duration-300 text-center flex flex-col items-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Paket Wisata Menarik</h3>
                        <p class="text-gray-500 text-sm leading-relaxed">
                            Pilihan paket perjalanan lengkap mulai dari pantai, wisata budaya, hingga petualangan alam liar.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 hover:shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-shadow duration-300 text-center flex flex-col items-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Rental Mobil Nyaman</h3>
                        <p class="text-gray-500 text-sm leading-relaxed">
                            Armada mobil ber-AC prima dengan sopir berpengalaman, siap melayani perjalanan keliling Bali.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 hover:shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-shadow duration-300 text-center flex flex-col items-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Layanan Siaga 24/7</h3>
                        <p class="text-gray-500 text-sm leading-relaxed">
                            Dukungan penuh tim Indo Bali Tour yang siaga merespons segala keperluan darurat liburan Anda.
                        </p>
                    </div>
                </div>
            </div>
