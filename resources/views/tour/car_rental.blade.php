    ...
    <footer class="bg-[#151515] text-gray-400 pt-16 pb-6 text-xs">
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
                ...
                <div class="flex space-x-3 text-gray-500 mt-2">
                    <span class="w-6 h-6 bg-gray-800 rounded-full inline-block"></span>
                    <span class="w-6 h-6 bg-gray-800 rounded-full inline-block"></span>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 pt-6 border-t border-gray-800 text-center text-gray-500 text-[11px]">
