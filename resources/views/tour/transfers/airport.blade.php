                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100 text-sm">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors" x-show="Math.floor({{ $index }} / itemsPerPage) === activePage">
                            ...
                            <td class="py-5 px-6 text-center font-bold text-lg text-[#9B1C26]"><span x-html="$store.currency.format({{ $airport->price ?: 0 }})">$ {{ number_format((float)$airport->price, 2) }}</span></td>
                ...
                <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-5 flex flex-col gap-3 relative" x-show="Math.floor({{ $index }} / itemsPerPage) === activePage">
                    <div class="flex justify-between items-start gap-4">
                        ...
                        <div class="text-right shrink-0">
                            ...
                            <p class="font-bold text-lg text-[#9B1C26]"><span x-html="$store.currency.format({{ $airport->price ?: 0 }})">$ {{ number_format((float)$airport->price, 2) }}</span></p>
                        </div>
                    </div>
                    <div>
