...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] text-gray-900 antialiased font-sans">
        ...
        <!-- Blog Hero Section -->
        <div class="relative h-[350px] md:h-[480px] w-full bg-cover bg-center" style="background-image: url('{{ asset('images/' . $blog->img) }}');">
                ...
                <div class="max-w-7xl mx-auto px-4 w-full pb-10 md:pb-16">
                    <div class="max-w-3xl">
                        ...
                        <div class="flex items-center space-x-2 text-xs text-gray-300 mb-4 font-medium uppercase tracking-wider">
                            ...
                            <span>/</span>
                            <span class="text-white truncate max-w-[200px]">NEWS</span>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-gradient-to-br from-brand-red to-brand-dark-red text-white rounded-2xl p-8 shadow-md relative overflow-hidden group">
                        ...
                        <h3 class="text-lg font-bold mb-3" data-aos="fade-up" data-aos-delay="150">Rencanakan Liburan Anda Sekarang!</h3>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6" data-aos="fade-up" data-aos-delay="200">
                        <h3 class="text-sm font-extrabold text-gray-900 uppercase tracking-wider mb-5 pb-3 border-b border-gray-50" data-aos="fade-up" data-aos-delay="150">
                            Artikel Rekomendasi
                        </h3>
                        <div class="space-y-5">
                            @foreach($otherBlogs as $otherItem)
                            <a href="{{ route('blog.show', $otherItem->slug) }}" class="flex items-start space-x-3 group block">
                                <div class="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0 bg-gray-100">
                                    <img src="{{ asset('images/' . $otherItem->img) }}" alt="{{ $otherItem->title }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                                </div>
                                <div class="flex-1 min-w-0">
                                    ...
                                    <span class="block text-[9px] text-gray-400 mt-1">
                                        {{ \Carbon\Carbon::parse($otherItem->date)->format('d M Y') }}
                                    </span>
                                </div>
                            </a>
                            @endforeach
