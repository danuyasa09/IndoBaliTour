...
@section('subtitle', 'Buat paket tour baru untuk ditawarkan')
    ...
    <form action="{{ route('admin.tours.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="short" id="short" rows="2" class="summernote w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red">{{ old('short') }}</textarea>
            ...
            <div>
                ...
                <input type="number" name="harga" id="harga" value="{{ old('harga') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red">
                @error('harga')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
            </div>

            <div>
                <label for="date" class="block text-sm font-medium text-gray-700 mb-1">Tanggal</label>
                <input type="date" name="date" id="date" value="{{ old('date') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red">
                @error('date')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
            </div>

            <div>
                <label for="harga_detail" class="block text-sm font-medium text-gray-700 mb-1">Detail Harga Singkat (Teks)</label>
                <input type="text" name="harga_detail" id="harga_detail" value="{{ old('harga_detail') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" placeholder="e.g. / pax">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="pricelist" id="pricelist" rows="4" class="summernote w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red">{{ old('pricelist') }}</textarea>
