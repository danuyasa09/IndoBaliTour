...
@section('subtitle', 'Ubah data artikel blog / berita')

@section('actions')
<a href="{{ route('admin.blogs.index') }}" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm font-medium transition-colors">
    ...
    <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="title" id="title" value="{{ old('title', $blog->title) }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" required>
            ...
            <div>
                ...
                <input type="date" name="date" id="date" value="{{ old('date', $blog->date ? $blog->date->format('Y-m-d') : '') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" required>
            ...
            <div>
                ...
                <select name="status" id="status" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" required>
                    <option value="Show" {{ old('status', $blog->status) == 'Show' ? 'selected' : '' }}>Tampilkan (Show)</option>
                    <option value="Hide" {{ old('status', $blog->status) == 'Hide' ? 'selected' : '' }}>Sembunyikan (Hide)</option>
                </select>
            ...
            <div>
                ...
                <input type="number" name="hit" id="hit" value="{{ old('hit', $blog->hit ?? 0) }}" min="0" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" required>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="caption" id="caption" rows="2" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red">{{ old('caption', $blog->caption) }}</textarea>
            ...
            <div>
                ...
                <input type="text" name="tags" id="tags" value="{{ old('tags', $blog->tags) }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" placeholder="wisata, bali, pantai">
            ...
            <div>
                ...
                <input type="text" name="keyword" id="keyword" value="{{ old('keyword', $blog->keyword) }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" placeholder="wisata bali murah">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="id_category" id="id_category" value="{{ old('id_category', $blog->id_category) }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" placeholder="Masukkan ID atau nama kategori">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="content" id="content" rows="10" class="summernote w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red" required>{{ old('content', $blog->content) }}</textarea>
